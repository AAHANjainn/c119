...
document.getElementById("sketch_name").innerHTML = "Sketch to be drawn : " + sketch_name;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function draw() {
    ...
    if (drawn_sketch == sketch_name) {
        ...
        score = score + 1;
        document.getElementById("score_h2").innerHTML = "Score = " + score;
    }
    strokeWeight(13);
    stroke(0);
    if(mouseIsPressed){
...
function gotResult(error,results){
    ...
    document.getElementById("Confidence").innerHTML = "Your Confidence" + Math.round(results[0].confidence * 100) + "%";
...
function checksketch() {
    ...
    document.getElementById("timer_h2").innerHTML = "Timer = " + timer_counter;
